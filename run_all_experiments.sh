...
python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.1 --Ct 0.1 --K 10
python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.01 --Ct 0.1 --K 10

python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.001 --Ct 0.1 --K 10


python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.1 --Ct 0.1 --K 200
python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.01 --Ct 0.1 --K 200

python main.py --dataset school --algorithm Sheaf-FMTL-subgraph --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.001 --Ct 0.1 --K 200
...
python main.py --dataset school --algorithm Sheaf-FMTL --alpha 0.005 --eta 0.05 --lambda-reg 0.02 --factor 0.4 --num-rounds 200 --times 5 --beta 0.001 --Ct 0.4 --K 200

python main.py --dataset school --algorithm dFedU --K 200 --times 5
